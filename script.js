...
function showMeme() {
  ...
  const mem = document.getElementById("memer");

  mem.appendChild(newElement);
...
function showJoke() {
  ...
  const jok = document.getElementById('joker');
  jok.appendChild(newElement);
  clearAll('memer');
  clearAll('quotor');
  clearAll('riddler');
}
...
function showQuote() {
  ...
  const newElement = document.createElement('p');
  newElement.textContent = randomQuote.quote + ' by ' + randomQuote.author;
  const qot = document.getElementById('quoter');
  qot.appendChild(newElement); 
...
function showRiddle() {
  ...
  clearAll('riddler');
  clearAll('ridans');  // Value should be in format: { question: '', answer: '' }
  const randomRiddle = getRandomData("riddles");
  const newElement = document.createElement('p');
  newElement.textContent = randomRiddle.question;
  const newerElement = document.createElement('p');
  ridd = randomRiddle.answer;
  const rid = document.getElementById('riddler');
  const rida = document.getElementById('ridans');

  rid.appendChild(newElement);
...
function revealAnswers() {
    ...
    anselement.textContent = ridd;
const emnt = document.getElementById('riddler')
const ans = document.getElementById('ridans');
if(emnt.textContent == '' && ans.textContent == ''){
    alert('Wait Theres no riddle!');
} else if(emnt.textContent != '' && ans.textContent != ''){
